        ...
        <div class="row gy-4">
          ...
          <div class="col-md-3" data-aos="fade-up" data-aos-delay="100">
            <div class="services-list">
              ...
              <a href="#" class="active">Data User</a>
          ...
          <div class="col-md-9" data-aos="fade-up" data-aos-delay="200">
            <div class="container" id="produk">
              <h1>Daftar User</h1>
              <a href="register.php" class="btn btn mb-3" style="background: #20664f; color: #ffffff">Tambah User</a>
              <table class="table">
                <thead>
                  <tr>
                    <th>ID</th>
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<a href='detail.php?id=" . $row["iduser"] . "' class='btn btn-success btn-sm'>Detail</a> ";

                      // The key change is here:  Make sure edit.php exists and handles the ID
                      echo "<a href='edit-user.php?id=" . $row["iduser"] . "' class='btn btn-warning btn-sm'>Edit</a> ";

                      echo "<a href='#' class='btn btn-danger btn-sm' onclick=\"if (confirm('Apakah Anda yakin ingin menghapus user ini?')) { window.location.href='hapususer.php?id=" . $row["iduser"] . "'; }\">Hapus</a>";
