                ...
                <div class="row gy-4">
                    ...
                    <div class="col-md-8" data-aos="fade-up" data-aos-delay="200">
                        <div class="container" id="produk">
                            <h1>Daftar User</h1>
                            <a href="tambah.php" class="btn btn mb-3" style="background: #20664f; color: #ffffff">Tambah
                                Data</a>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>";
                                            echo "<a href='edit.php?id=" . $row["nip"] . "' class='btn btn-warning btn-sm'>Edit</a> ";
                                            echo "<a href='hapus.php?id=" . $row["nip"] . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus produk ini?')\">Hapus</a>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                    } else {
